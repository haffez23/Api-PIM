        ...
        if (err)
            ...
            res.json({
                ...
                data: message.filter(function(e,i){
                    console.log('Date now'+new Date().toISOString()+"===Date E"+e.displayAt.toISOString())

                    if((new Date().toISOString() >= e.displayAt.toISOString() && new Date().toISOString() <= e.hiddenAt.toISOString()) ||
                    (e.displayAt.toISOString() >= new Date().toISOString() && new Date().toISOString() <= e.hiddenAt.toISOString()))
                    return e
